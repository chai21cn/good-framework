using GoodFramework.Abp.WeChat.MiniProgram.Messages;
using GoodFramework.Abp.WeChat.Security.Claims;
...
namespace GoodFramework.Abp.Notifications.WeChat.MiniProgram
{
    /// <summary>
    /// 微信小程序消息推送提供者
    /// </summary>
