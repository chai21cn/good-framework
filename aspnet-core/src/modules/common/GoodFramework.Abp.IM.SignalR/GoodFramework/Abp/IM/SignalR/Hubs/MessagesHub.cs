...
using GoodFramework.Abp.IM.Contract;
using GoodFramework.Abp.IM.Groups;
using GoodFramework.Abp.IM.Localization;
using GoodFramework.Abp.IM.Messages;
using GoodFramework.Abp.RealTime;
using GoodFramework.Abp.RealTime.Localization;
...
namespace GoodFramework.Abp.IM.SignalR.Hubs
{
    [Authorize]
