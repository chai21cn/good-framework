...
using GoodFramework.Abp.Identity.Security;
using GoodFramework.Abp.Identity.Settings;
...
using IIdentityUserRepository = GoodFramework.Abp.Identity.IIdentityUserRepository;
