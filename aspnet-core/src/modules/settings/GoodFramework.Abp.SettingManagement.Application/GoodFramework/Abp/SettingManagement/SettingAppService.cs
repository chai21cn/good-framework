    ...
    public class SettingAppService : ApplicationService, ISettingAppService
    {
        ...
        protected virtual async Task<SettingGroupResult> GetAllForProviderAsync(string providerName, string providerKey)
        {
            ...
            userSetting.AddDetail(
                ...
                providerName);
            userSetting.AddDetail(
                SettingDefinitionManager.Get(GoodFramework.Abp.Identity.Settings.IdentitySettingNames.User.SmsNewUserRegister),
                StringLocalizerFactory,
                await SettingManager.GetOrNullAsync(GoodFramework.Abp.Identity.Settings.IdentitySettingNames.User.SmsNewUserRegister, providerName, providerKey),
                ValueType.String,
                providerName);
            userSetting.AddDetail(
                SettingDefinitionManager.Get(GoodFramework.Abp.Identity.Settings.IdentitySettingNames.User.SmsResetPassword),
                StringLocalizerFactory,
                await SettingManager.GetOrNullAsync(GoodFramework.Abp.Identity.Settings.IdentitySettingNames.User.SmsResetPassword, providerName, providerKey),
                ValueType.String,
                providerName);
            userSetting.AddDetail(
                SettingDefinitionManager.Get(GoodFramework.Abp.Identity.Settings.IdentitySettingNames.User.SmsUserSignin),
                StringLocalizerFactory,
                await SettingManager.GetOrNullAsync(GoodFramework.Abp.Identity.Settings.IdentitySettingNames.User.SmsUserSignin, providerName, providerKey),
                ValueType.String,
                providerName);
            userSetting.AddDetail(
                SettingDefinitionManager.Get(GoodFramework.Abp.Identity.Settings.IdentitySettingNames.User.SmsPhoneNumberConfirmed),
                StringLocalizerFactory,
                await SettingManager.GetOrNullAsync(GoodFramework.Abp.Identity.Settings.IdentitySettingNames.User.SmsPhoneNumberConfirmed, providerName, providerKey),
                ValueType.String,
                providerName);
            userSetting.AddDetail(
                SettingDefinitionManager.Get(GoodFramework.Abp.Identity.Settings.IdentitySettingNames.User.SmsRepetInterval),
                StringLocalizerFactory,
                await SettingManager.GetOrNullAsync(GoodFramework.Abp.Identity.Settings.IdentitySettingNames.User.SmsRepetInterval, providerName, providerKey),
                ValueType.Number,
                providerName);
