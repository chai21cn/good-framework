using AutoMapper;
using GoodFramework.Abp.IdentityServer.ApiResources;
using GoodFramework.Abp.IdentityServer.ApiScopes;
using GoodFramework.Abp.IdentityServer.Clients;
using GoodFramework.Abp.IdentityServer.Grants;
using GoodFramework.Abp.IdentityServer.IdentityResources;
